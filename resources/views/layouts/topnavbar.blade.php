<div class="row border-bottom">
    <nav class="navbar navbar-static-top" role="navigation"
         style="margin-bottom: 0;    background: #075f98 !important;">
        ...
        <ul class="nav navbar-top-links navbar-right" style="margin-right:
        0px !important;">
            <li class="dropdown">
            ...
            <li>
                <a data-toggle="dropdown" class="dropdown-toggle">
                            ...
                            <span class="block m-t-xs">
                                <strong class="font-bold"><i class="fa fa-user"></i></strong><b class="caret"></b>
                            </span>
                </a>
                <ul class="dropdown-menu animated fadeInRight m-t-xs" id="profile_dropdown">
                    <li>
                        <a href="#"
                           target="_blank"><span class="fa fa-lock"></span> Privacy
                            Policies</a>
                    </li>
                    <li>
                        <a href="#"
                    ...
                    <li>
                        <a href="{{url('/faq')}}" id="faq"  style="color:#777 ;">
                            ...
                            FAQ</a></li>
                    <li><a href="{{url('/troubleshoot')
                                        }}" style="color:#777;" tabindex="-1"><span class="fa
                                        fa-wrench "></span>
                            Troubleshoot</a></li>
                    <li >
                        <a href="" data-toggle="modal" id="languages"
                           data-id="5"
