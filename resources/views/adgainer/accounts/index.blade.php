                ...
                <tbody id="account_list">
                    ...
                    foreach ( $accounts as $account ) {
                        ...
                        <tr class="account-item">
                            ...
                            <td class="text-center">
                                <a href="account/details/{!! $account->account_id !!}" class="btn btn-default btn-sm">
                                    View
                                </a>
                                <!-- TODO: Edit by level = 1 | (application/views/account/accounts.php|225)--> 
                                <a href="account/edit/{!! $account->account_id !!}" class="btn btn-default btn-sm">
                                    Edit
                                </a>
                            </td>
                        </tr>
...
<script>
    (function($){
        $(function( ){
            ...
            var selectedAccountName = $('#selectedAccountName');
            $('.show-account-campaigns').click(function(){
                ...
                selectedAccountName.html(accountName);
                // remove filter
                filterCampaignInput.val('');
                // send request
                var url = '/api/adgainer/campaign-rows/' + accountID;
                campaignList.html('');
