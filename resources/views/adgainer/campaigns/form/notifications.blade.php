<div role="tabpanel" class="tab-pane" id="notification">
    <table class="table-form" style="width: 700px; max-width: 100%;">
        <tr>
            <td style="vertical-align: top;"><label><small>Notify Low Numbers + Report:-</small></label></td>
            <td>
                Yes <input type="radio" name="email_notify" checked value="1"/> 
                No <input type="radio" name="email_notify" value="0" /> <br/>
        ...
        <tr>
            ...
            <td>
                Yes <input type="radio" name="email_notify_user" value="1" checked /> 
                No <input type="radio" name="email_notify_user" value="0" /> <br/>
                Email(s): <i>i.e. email@adgainer.com,hello@adgainer.com</i> up to 20 <br/>
