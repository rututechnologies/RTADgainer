...
<div id="da-content-area" style='margin-left:80px'>
						 ...
						 <div class="grid_3">
							...
							<div class="da-panel">
									...
									<div class="da-panel-header">
										<tr><span class="da-panel-title">
											<td><img src="https://testenvadgainer.adgainersolutions.com/adgainer/application/images//icons/black/16/documents.png" alt="">
									...
									<div class="da-panel-content">
											...
											<div class="da-form-row">
												...
												<div class="da-form-item large">
													...
													<div class="rowValue">
														<td><select id="chat_account" class="textShadow">
													...
													<div class="rowValue">
														<td><select id="chat_dept" class="textShadow" >
															<option value=''>Select an Account</option>
														</select></td>
														<tr> <td><td>(optional)</td></td></tr>
													</div></tr>
													<tr><div class="rowName">
														<td>Message</td>
													</div>
													<div class="rowValue">
														<td><textarea id="chat_message" rows="10" cols="50" class="textShadow1"></textarea></td>
													</div>
													...
													<div class="rowValue">
														<td><button id="save_pre_gen" class="da-button_green">Save Message</button></td>
													</div></tr>
