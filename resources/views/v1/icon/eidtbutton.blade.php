...
<div id="menu1" class="tab-pane fade in active">
                                            ...
                                            Account - ADgainer                                      </span>
    
    <hr>
    <table cellspacing="50">
    <tr>
    <td>
    <table cellspacing="35" style='margin-bottom:600px'>
    <tr>
    
                    <td><label>Account Name</label></td>
                    
                        <td><input type="text" name="accountName" value="ADgainer"  class="req" required></td> 
                </tr>
<tr>
                
                   <td> <label>Username</label></td>
                    
                        <td><input type="text" name="accountName" value="Admin"  class="req" required></td> 
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><label>Telephone</label></td><td><input type="text" name="accountName" value=""  class="req" ></td></tr>
                   
                    
                
                <tr>
               
                    <td><label>Address</label></td><td><input type="text" name="accountName" value=""  class="req" ></td></tr>
...
<tr>
                ...
                <td><input type="text" name="accountName" value=""  class="req" ></td></tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><label>Country</label></td>
                        ...
                        <td><select name="country" id="country" disabled="disabled">
            ...
            <tr>
                    ...
                    <td><label>Contact</label></td><td><input type="text" name="accountName" value=""  class="req" ></td>
                ...
                <tr>
                    ...
                    <td><label>Email</label></td>
                        ...
                        <td><input type="text" name="accountName" value="christiang@adgainer.com"  class="req" ></td> 
                </tr>
<tr>
                
                  <td>  <label>Offline Chat Image</label></td>
                
                        <td><input type="file"  name="offline_img" /> OfflineButton.png 100KB Max &nbsp;&nbsp; 150x30px Max</td>
                </tr>
                <tr>
                
                    <td><label>Online Chat Image</label></td>
                    
                        <td><input type="file"  name="online_img" /> OnlineButton.png 100KB Max &nbsp;&nbsp; 150x30px Max</td> 
                </tr>
                ...
                <tr>
                    ...
                    <td><label>Account Pin *</label></td>
                        ...
                        <td>    Required. Must be 5 numbers in length. <br>
                                                    <input type="text"  name="account_pin"  id="account_pin" value="22222" class="req" required></td> 
                </tr>
                <tr>
                <td><label>Account Subsidiary</label></td>
                <td><select name="account_subsidiary" >
                ...
                <td><select name="account_currency" id="account_currency">
                ...
                <td><select name="account_language" id="account_language" style="width:80%">
                ...
                <td><select name="account_time_zone" id="account_time_zone">
...
<tr>
                ...
                <tr>
                    ...
                    <td><label>Account Manager</label></td>
                     ...
                     <td>  <input type="text" name="account_mgr" value="christiang@adgainer.com" /></td> 
                </tr>
                <tr>
                
                    <td><label>PPC Markup</label></td>
                    
                        <td><input type="text"   name="ppc_markup"  style="width:100px" value="25"  /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; = (100 - %)</td> 
                </tr>
                <tr>
               
                    <td>    <label>Adwords Client ID  ie. 123-456-7890 </label></td>
                    
                        <td><input type="text" name="adw_client_id" value=""/></td> 
                </tr>
                    ...
                    <button rel="acctBillSection" class="sectionNext da-button green" onClick="return false">Next</button>
...
<tr>
<td>
<table cellspacing="35" style='margin-bottom:380px'>     
...
<tr>
                    ...
                    <td><input type="text" name="billing_address_1" value="" /></td></tr>

                
<tr>
                
                   <td> <label>Billing Address </label></td>
                    <td><input type="text" name="billing_address_2" value="" /></td></tr>
...
<tr>
                   ...
                   <td><input type="text" name="billing_state" value="" /></td></tr>
...
<tr>
                    ...
                    <td><label>Billing Country</label></td>
                        ...
                        <td><select name="billing_country" id="billing_country">
                            <option value="" selected="selected">Select Country</option>
                            <option value="United States">United States</option>
                            <option value="Japan">Japan</option>
                            <option value="Afghanistan">Afghanistan</option>
...
<tr>
                    ...
                    <td><label> Billing Date</label></td>
                        ...
                        <td><input type="text" name="billing_date" /></td>
                ...
                <tr>
                   ...
                   <td><input type="text" name="name_on_card" value="" /></td>
...
<tr>
                    ...
                    <td><label> Expiration </label></td>
                       ...
                       <td> MM: <input type="date" name="exp_m" style="width:150px" value="0" >

                                                     /
                                                    YY: <input type="date" name="exp_y" style="width:150px" value="0" ></td>
...
<tr>
         ...
         <a href="{{url('buttonform')}}"><input type="submit"></a>
        </td>
        </tr>
        </table>
