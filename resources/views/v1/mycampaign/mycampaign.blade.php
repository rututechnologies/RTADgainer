...
<div class="da-form-item">
														...
														&nbsp;&nbsp;&nbsp;Date:&nbsp;&nbsp;&nbsp;From: <input type="date" id="date1" name="date1" style="width:75px" value="02/01/2018" class="dateChange" />
														To: <input type="date" id="date2" style="width:75px" value="02/19/2018" class="dateChange"  /><br><br>
