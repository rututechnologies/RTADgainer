         ...
         <br>               <div class="grid_4">
                    ...
                    <div class="da-panel-header" id='test0'>
                        <span class="da-panel-title" id='test1'>
                            <td><img src="https://testenvadgainer.adgainersolutions.com/adgainer/application/images//icons/black/16/pencil.png" alt="">
                            <b>Create a Report</b><hr></span></td>
                            </div></tr>
                    ...
                    <div class="da-form-row">
                        ...
                        <table> <tr><div class="rowName">
                            ...
                            <div class="rowValue" class="textShadow">
                                                                <td><select id="goal_account_id" name="account_id" class="textShadow">
                            ...
                            <tr><div class="clear" style="height:10px"></div>
                            <div class="rowName">
                                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Campaign:*</td>
                            </div>
                            <div class="rowValue">

                                <td><select id="goal_campaign_id" name="campaign_id" class="textShadow">
                                    <option value="">Select an Account</option>
                                 </select></td>
                            ...
                            <div class="rowValue">
                                <td><input type="text" id="click_name" name="click_name"class="textShadow"/></td>
                            </div></tr>


                            <tr><div class="clear" style="height:10px"></div>
                            <div class="rowName">
                                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Click ID: <i>HTML ID</i></td>

                            </div>
                            <div class="rowValue">
                                 <td><input type="text" id="click_id" name="click_id" / class="textShadow"></td>
                            ...
                            <tr><div class="clear" style="height:10px"></div>
                            <div class="rowName">
                                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Click Class: <i>HTML Class</i></td>
                            </div>
                            <div class="rowValue">
                                <td><input type="text" id="click_class" name="click_class" class="textShadow" /></td>
                            ...
                            <div class="rowValue"> 
                                <td><input type="text" id="URL" nme="URL" class="textShadow" class="textShadow"/></td>
                            ...
                            <div class="rowValue">
                                <td>Yes <input type="radio" name="email_send" value="1"/></td>
                                
                                <td>No <input type="radio" name="email_send" value="0" /></td>
                            </div></tr>
                            ...
                            <div class="rowValue">
                                ...
                                <td><select id="goal_count" name="goal_count" class="textShadow">
