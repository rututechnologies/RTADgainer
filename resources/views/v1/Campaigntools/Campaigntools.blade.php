...
<div class="w3-container">
    &nbsp;&nbsp;&nbsp;
                                                    ...
                                                    <br><br>
                                                        ...
                                                        Date:&nbsp;&nbsp;&nbsp;From:&nbsp;&nbsp; <input type="date" id="date1" style="width:150px" value="02/01/2018" class="dateChange" />
                                                        To:&nbsp; &nbsp;<input type="date" id="date2" style="width:150px" value="02/19/2018" class="dateChange"  />
