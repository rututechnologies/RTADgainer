...
@section('content')
 <div class="wrapper border-bottom white-bg page-heading">
  ...
  <div class="container-fluid">
	...
	<li><a href=""></a></li>
      <li ><a href=""></a></li>
      <li class="active"><a href="">Create A Goal</a></li>
      <li><a href=""></a></li>
      <li><a href=""></a></li>
    </ul>
  </div>
...
<td><div class="rowName">
								Account:
																...
																<td><select id="goal_account_id" name="account_id" class="req">
							...
							<div class="rowValue">
															...
															<td>	<select id="goal_campaign_id" name="campaign_id" class="req">
									<option value="">Select an Account</option>
								 </select></td>
								 </div></tr>
							...
							<div class="rowValue">
								<td><input type="text" id="click_name" name="click_name" />
							</div></td></tr>


							<div class="clear" style="height:10px"></div>
							<td><div class="rowName">
								Click ID: <i>HTML ID</i>

							</div></td>
							<div class="rowValue">
								<td> <input type="text" id="click_id" name="click_id" />
                           ...
                           <tr>
							...
							<div class="clear" style="height:10px"></div>
							<td><div class="rowName">
								Click Class: <i>HTML Class</i>
							</div></td>
							<div class="rowValue">
								<td><input type="text" id="click_class" name="click_class" />
							...
							<div class="rowValue">
								<td><input type="text" id="URL" nme="URL" />
								 </td>
							</div></tr>
                                <tr>
							<div class="clear" style="height:10px"></div>
							...
							<td><div class="rowValue">
								...
								Yes <input type="radio" name="email_send" value="1" />
								&nbsp;&nbsp; | &nbsp;&nbsp;
								No <input type="radio" name="email_send" value="0" />
							...
							<div class="rowValue">
								...
								<td><select id="goal_count" name="goal_count" class="req">
...
<tr>
					...
					<td><div class="da-button-row">
						...
						<input type="submit" value="Save Goal" class="da-button green">
					</div></td></tr>
					</table>
				</form>
