...
<form action='viewCampaign' method='any'>
...
@foreach($tdata as $key => $data)
								    ...
								    <td><a href="{{url('callrecords')}}">0 </a></td>
										<td><a href="{{url('callrecords')}}">{{$data->avgClicks}}</td>
										<td><a href="{{url('callrecords')}}">{{$data->ppc_markup}}</td>
										<td><a href="{{url('callrecords')}}">0</a></td>
										<td><a href="{{url('callrecords')}}">0</a></td>
										<td><a href="{{url('callrecords')}}">0</a></td>
										<td><a href="{{url('callrecords')}}">0</a></td>
										<td>{{$data->avgCalls}}</td>
										<td><a href="{{url('callrecords')}}">{{$data->goalsThresh}}</a></td>
										<td>{{$data->emailsThresh }}</td> 
										<td><a href="{{url('callrecords')}}">{{$data->avgConversions}}</a></td>
										<td>{{$data->avgConversions}}</td>
									@endforeach	
	</tr></table>
  @else
...
@if($tdata)
@foreach($tdata as $key => $data)
  <tr><td> {{$data->campaign_name}}</td>
    <td>{{$data->campaign_budget}}</td>
