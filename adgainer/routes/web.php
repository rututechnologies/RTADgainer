...
Route::post( 'adgainer/index.php/incomingdata/getCode', [ 'uses' => 'IncomingDataController@getCode' ] );
Route::post( 'adgainer/incomingdata/tagManager', [ 'uses' => 'IncomingDataController@tagManager' ] );
Route::post( 'adgainer/index.php/incomingdata/tagManager', [ 'uses' => 'IncomingDataController@tagManager' ] );
